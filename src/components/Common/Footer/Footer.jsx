      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Pune, Maharashtra, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:rawatcoder@gmail.com" className="d-block" >gauriii@gmail.com</a>
          </div>
        ...
        <p className="text-light">   @ 2024. Gauriii All rights reserved </p> 
        </Col>
        </Row>
